...
const uint16_t sec1 = 1999;
const uint16_t sec19 = 9999;//37999
...
void MX_TIM6_Init(void)
{
  ...
  /* USER CODE BEGIN TIM6_Init 0 */
	// Timer used to control the time interval of sensor data sent to Android
	// Set to 
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = SEN1_Pin|SEN2_Pin;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOA, SEN1_Pin|SEN2_Pin);
